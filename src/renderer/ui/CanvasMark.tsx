...
function CanvasMark({ className }: { className?: string }): React.JSX.Element {
  return (
    <svg viewBox="0 0 96 96" className={className} aria-hidden="true">
      ...
      <rect x="10" y="18" width="34" height="22" rx="6" fill="#8FBEE3" />
      <rect x="56" y="14" width="30" height="20" rx="6" fill="#E398AB" />
      <rect x="28" y="58" width="36" height="24" rx="6" fill="#B2CE7E" />
    </svg>
  )
}
