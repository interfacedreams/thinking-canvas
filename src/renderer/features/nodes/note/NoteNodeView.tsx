...
import { useCanvasStore, MAX_NODE_H, notePager, type NoteNode } from '@renderer/store/canvas'
...
import TransformFrame from '@renderer/features/canvas/overlays/TransformFrame'
import {
  CHIP_BUTTON,
  CTX_HANDLE_ID,
  ctxHandleStyle,
...
import { type NoteEditorHandle } from '@renderer/features/nodes/note/NoteEditor'
